    ...
    if (
        ...
        try {
            ...
            if ($testimonialRepo) {
                ...
                $testimonialRepo->setFeatured($id, $is_featured);
            }

        } catch (Throwable $e) {

            error_log('Testimonial feature error: ' . $e->getMessage());
        }
    }
                ...
                <?php foreach ($testimonials as $testimonial): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if ((int)$testimonial['is_featured'] === 1): ?>
                        ...
                        <td>
                            ...
                            <div class="actions">
                                ...
                                <?php if ((int)$testimonial['is_featured'] === 1): ?>
                                    ...
                                    <a
                                        href="?action=unfeature&id=<?php echo (int)$testimonial['id']; ?>"
                                        class="btn unfeature"
                                    >
                                        Remove
                                    </a>
                                ...
                                <?php else: ?>
                                    ...
                                    <a
                                        href="?action=feature&id=<?php echo (int)$testimonial['id']; ?>"
                                        class="btn feature"
                                    >
                                        Feature
                                    </a>
