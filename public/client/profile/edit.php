...
<head>
    ...
    <style>
        *{ margin:0; padding:0; box-sizing:border-box; }
        ...
        .profile-container{ background:#fff; padding:35px; border-radius:20px; box-shadow:0 5px 20px rgba(0,0,0,0.08); max-width:1000px; }
        .profile-header{ display:flex; align-items:center; gap:25px; margin-bottom:35px; flex-wrap:wrap; }
        .profile-image{ width:120px; height:120px; border-radius:50%; object-fit:cover; border:5px solid #f5b400; }
        .avatar{ width:120px; height:120px; border-radius:50%; background:#111827; color:#fff; display:flex; align-items:center; justify-content:center; font-size:40px; font-weight:bold; }
    ...
    <div class="profile-container">
        <div class="profile-header">
            <?php if (!empty($client['profile_image'])): ?>
                <img src="../../uploads/profile/<?php echo htmlspecialchars((string)$client['profile_image']); ?>" class="profile-image" alt="Profile Image">
            <?php else: ?>
                <div class="avatar"><?php echo strtoupper(substr(htmlspecialchars((string)$client['full_name']), 0, 1)); ?></div>
            <?php endif; ?>
            <div>
                <h2><?php echo htmlspecialchars((string)$client['full_name']); ?></h2>
