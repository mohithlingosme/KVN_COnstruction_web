...
try {
    $result = $conn->query("SELECT * FROM quotations ORDER BY id DESC LIMIT 100");
    $quotations = $result ? $result->fetch_all(MYSQLI_ASSOC) : [];
} catch (Throwable $e) {
    $error = 'An error occurred: ' . $e->getMessage();
    error_log('Quotations error: ' . $e->getMessage());
    $quotations = [];
}
?>
...
<head>
    ...
    <title>Quotations | KVN Construction</title>
